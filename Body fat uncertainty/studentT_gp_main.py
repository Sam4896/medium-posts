...
from model import create_studentT_botorch_model
...
def main() -> None:
    ...
    """
    # Load data without removing outliers
    ...
    print("--- Training model with Student-T Likelihood ---")
    model = create_studentT_botorch_model(train_X, train_Y).to(
